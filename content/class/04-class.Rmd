...
I've noticed some confusion about what I call "saving your work", so we'll go over the slides above.
...
myvec_fac2 <- factor(myvec, levels = c("dog", "cat", "mouse"))
levels(myvec_fac2)
