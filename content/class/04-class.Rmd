...
[Dr. Kelly Bodwin's formediums/factor](https://www.youtube.com/watch?v=bBfZFasd61c)
...
I usually turn something into a factor for plotting (especially if I have a mediumegorial numeric variable), and we'll see more examples of that. We also later will see how it matters in statistical modeling/regression. It also is often easier to manage levels/mediumegories this way, as we will see when we talk about the `formediums` package again in class 6.
...
- We will talk more about palettes when we finish part4 but there are many, many. I suggest finding a package or two that has the palettes you like and working with those. See a bunch listed [here (scroll down in the readme).](https://github.com/EmilHvitfeldt/r-color-palettes)
